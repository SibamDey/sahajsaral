...
const NominalAccountDelete = () => {
    ...
    const { data: nominalAccList } = useQuery({
        ...
        queryFn: async () => {
            const data = await fetch.get("/StateAccountCode/Get?lgdCode=" + userData?.CORE_LGD);
            return data?.data;
        },
    });
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-lg p-1 flex flex-col flex-grow" style={{ marginTop: "-40px" }}>
                <legend className="text-lg font-semibold text-cyan-700">Deletion of Nominal Account Code</legend>
                ...
                <div className=" flex justify-between items-center h-12">
                    <div className="flex items-center space-x-0">
                        ...
                        <button
                            ...
                            onClick={() => exportToExcel(data, "Nominal Account_code")}
                ...
                <div className="px-2 flex flex-col ">
                    <Table className="border border-gray-600 text-sm">
                        ...
                        <Table.Body className="divide-y text-xs border-gray-600">
                            {table.getRowModel().rows.map((row) => (
                                <Table.Row key={row.id} className="h-8">  {/* Reduced Row Height */}
...
export default NominalAccountDelete;
