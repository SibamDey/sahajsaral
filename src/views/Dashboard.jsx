      ...
      <div className="flex" id="main-content">
        <div
          className={classNames(
            ...
            "hide inset-y-0  bg-cyan-800 fixed overflow-y-auto transition-all duration-300",
            online ? "top-[55px] min-h-remaining" : "top-[80px] min-h-offline"
          )}
        >
          {actualVis && <Sidebar />}
        </div>
        ...
        >
          <div className="flex" >
            ...
            >
              {isSidebarOpen ? (
                <Icon
                  className="text-xl text-zinc-400 rotate-180 "
                ...
                <Icon
                  className="text-2xl text-blue-600 rotate-180"
          ...
          <Footer className="justify-items-end bg-cyan-300" />
        </div>
      </div>
    </div>
  );
