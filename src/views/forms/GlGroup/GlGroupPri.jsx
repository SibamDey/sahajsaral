...
const GlGroupPri = () => {
    ...
    const { data: schemeList } = useQuery({
        queryKey: ["schemeList"],
        queryFn: async () => {
            const data = await fetch.get(`/GlGroupPRI/Get?lgdCode=${userData?.CORE_LGD}&groupName=` + 0);
    ...
    const { mutate: addPed, isPending: addPending } = useMutation({
        mutationFn: (newTodo) => {
            return fetch.post(newTodo, "/GlGroupPRI/Insert");
        },
        onSuccess: () => {
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-lg p-2 flex flex-col flex-grow" style={{ marginTop: "-40px" }}>
                <legend className="text-lg font-semibold text-cyan-700">GL Group PRI Master</legend>
                    ...
                    <div className="flex flex-col w-full space-y-2">
                        ...
                        {userData?.USER_LEVEL === "HQ" ? "" :
                            <div className="w-1/6  ">
                                ...
                                // disabled={userData?.USER_LEVEL === "HQ" ? true : false}
                ...
                <div className=" flex justify-between items-center h-12">
                    <div className="flex items-center space-x-0">
                        ...
                        <button
                            ...
                            onClick={() => exportToExcel(data, "GL_Group_PRI")}
