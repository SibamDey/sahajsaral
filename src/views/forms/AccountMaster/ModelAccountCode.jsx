...
import { getNationalAccountCodeList, addInsertNominalAccountOB } from "../../../Service/OpeningBalance/OpeningBalance";
import * as XLSX from "xlsx";
import jsPDF from "jspdf";
import "jspdf-autotable";

const ModelAccountCode = () => {
    ...
    const onSearch = () => {
        if (!report) {
            ...
            getNationalAccountCodeList(userData?.CORE_LGD, report).then((response) => {
    ...
    return (
        <>
            ...
            <legend className="text-lg font-semibold text-cyan-700">National Account Code</legend>
                    ...
                    <div className="flex flex-col w-full mb-2 space-y-2">
                        <div className="flex items-center ">
                            ...
                            <div className="w-1/2">
                                ...
                                >
                                    Report For <span className="text-red-500 "> * </span>

                                </label>
                                <select id="DISTRICT" className="text-sm block w-full p-1 h-9 border border-gray-300 " onChange={onReport} value={report}>
...
export default ModelAccountCode;
