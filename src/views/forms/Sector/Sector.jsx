...
const Sector = () => {
    ...
    const { data: schemeList } = useQuery({
        queryKey: ["schemeList"],
        queryFn: async () => {
            const data = await fetch.get("/ParabaithakActivity/GetSector");
    ...
    const list = [
        ...
        {
            header: "Sector Name Bengali",
            accessorKey: "sectorNameBengali",
            headclass: "cursor-pointer",
        },
    ];
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-lg p-2 flex flex-col flex-grow" style={{ marginTop: "-40px" }}>
                <legend className="text-lg font-semibold text-cyan-700 py-4">Sector </legend>
