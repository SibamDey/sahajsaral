...
import {
    getPRIName,
    getVoucherUnverified,
    getPfpUnverified,
    getRealAcCode,
    getOtp,
    getOtpVerify,
    getMonthOpen
} from "../../../Service/Administrative/AdministrativeService";
...
const AdministrativeSecureWork = () => {
    ...
    const onUnverifiedVoucher = () => {
        if (!lgd) {
            ...
            getVoucherUnverified(lgd, voucherId, (r) => {
                console.log(r, "dd");
    ...
    const onMonthOpen = () => {
        if (!lgd) {
            ...
            getMonthOpen(lgd, financialYear, month, (r) => {
                console.log(r, "dd");
    ...
    const onRealAc = () => {
        if (!lgd) {
            ...
            getRealAcCode(lgd, acCode, currentBalance, (r) => {
                console.log(r, "dd");
    ...
    return (
        <div className="max-w-4xl mx-auto mt-10 p-6 bg-white rounded-2xl shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center mb-4">
                ...
                {lgdData ? (
                    <div className="md:col-span-3 text-blue-800">
                        Status: {lgdData?.priName}
                    </div>
                ) : (
                    ""
                )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center mb-4">
                ...
                <button
                    ...
                    onClick={onUnverifiedVoucher}
                >
                    Submit
                </button>

                {voucherData ? (
                    <div className="md:col-span-3 text-blue-700">
                        Status: {voucherData}
                    </div>
                ) : (
                    ""
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center mb-4">
                ...
                {monthData ? (
                    <div className="md:col-span-4 text-green-700">
                        Status: {monthData}
                    </div>
                ) : (
                    ""
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                ...
                {realAcData ? (
                    <div className="md:col-span-4 text-yellow-700">
                        Status: {realAcData}
                    </div>
                ) : (
                    ""
