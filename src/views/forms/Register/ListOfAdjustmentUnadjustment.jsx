...
export default function ListOfAdjustmentUnadjustment() {
...
<style>
  ...
  @media print {
    ...
    <body>
      <div class="header">
        ...
        <div class="title">
        <h2>${lgd[0]?.lsgName || "-"}</h2>
          <h3>LIST OF ADJUSTMENT/UNADJUSTMENT</h3>
        </div>
      </div>
  ...
  return (
    <div className="p-1 bg-white min-h-screen">
      <h3 className="text-lg font-semibold mb-1">List of adjustment/unadjustment</h3>
