...
const ObForNominalHQ = () => {
    ...
    const onLGD = (e) => {
        setLGD(e.target.value);
    }


    const onSearch = () => {
        if (!lgd) {
            toast.error("Please enter LGD");
