...
const HeadwiseJournal = () => {
    ...
    const { mutate: addPed, isPending: addPending, data: result, } = useMutation({
        mutationFn: (newTodo) => {
            return fetch.get(`/Register/HeadwiseJournal?lgdCode=${userData?.CORE_LGD}&frmDate=${fromDate.current.value}&toDate=${toDate.current.value}&glGroup=${accountHeadId ? accountHeadId : 0}&accountHead=${deductionHeadId ? deductionHeadId : 0}`);
        },
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-lg p-2 flex flex-col flex-grow" style={{ marginTop: "-40px" }}>
                <legend className="text-lg font-semibold text-cyan-700">Headwise Journal</legend>
                ...
                <div className=" flex justify-between items-center h-12">
                    <div className="flex items-center space-x-0">
                        ...
                        <button
                            ...
                            onClick={() => exportToExcel(data, "Headwise_Journal")}
...
export default HeadwiseJournal;
